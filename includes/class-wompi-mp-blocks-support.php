...
final class Wompi_MP_Blocks_Support extends AbstractPaymentMethodType {
	...
	public function get_payment_method_data() {
		...
		return array(
			...
			'i18n'        => array(
				'bankLabel'       => __( 'Banco', 'wompi-wp-moshipp' ),
				'bankPlaceholder' => __( '— Selecciona tu banco —', 'wompi-wp-moshipp' ),
				'bankInvalid'     => __( 'Selecciona tu banco e ingresa un documento válido para pagar con PSE.', 'wompi-wp-moshipp' ),
				'userTypeLabel'   => __( 'Tipo de persona', 'wompi-wp-moshipp' ),
				'phoneLabel'      => __( 'Número de celular Nequi', 'wompi-wp-moshipp' ),
				'phoneInvalid'    => __( 'Ingresa un número de celular Nequi válido (10 dígitos, inicia por 3).', 'wompi-wp-moshipp' ),
				'docTypeLabel'    => __( 'Tipo de documento', 'wompi-wp-moshipp' ),
				'docNumberLabel'  => __( 'Número de documento', 'wompi-wp-moshipp' ),
				'docInvalid'      => __( 'Ingresa un tipo y número de documento válidos para Daviplata.', 'wompi-wp-moshipp' ),
				'acceptPrefix'    => __( 'Acepto el', 'wompi-wp-moshipp' ),
				'policyText'      => __( 'reglamento de usuarios', 'wompi-wp-moshipp' ),
				'acceptMiddle'    => __( 'y la', 'wompi-wp-moshipp' ),
				'personalText'    => __( 'autorización de tratamiento de datos personales', 'wompi-wp-moshipp' ),
				'acceptSuffix'    => __( 'de Wompi.', 'wompi-wp-moshipp' ),
				'acceptRequired'  => __( 'Debes aceptar el reglamento y la autorización de datos de Wompi.', 'wompi-wp-moshipp' ),
			),
		);
	}
}
